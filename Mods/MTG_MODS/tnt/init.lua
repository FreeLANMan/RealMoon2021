...
local function tnt_explode(pos, radius, ignore_protection, ignore_on_blast, owner, explode_center)
	...
	local c_tnt_boom = minetest.get_content_id("vacuum:vacuum") 
...
function tnt.register_tnt(def)
    ...
    local tnt_top = def.tiles.top or "default_stone.png"
	--local tnt_bottom = def.tiles.bottom or def.name .. "_bottom.png"
    local tnt_bottom = def.tiles.bottom or "default_stone.png"
	--local tnt_side = def.tiles.side or def.name .. "_side.png"
    local tnt_side = def.tiles.side or "default_stone.png"
	local tnt_burning = def.tiles.burning or "default_stone.png"
